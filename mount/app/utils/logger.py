...
class Logger:
    def __init__(self, name, log_file='error.log', level=LogLevel.DEBUG, max_bytes=5*1024*1024, backup_count=5):
    ...
    def log_request(self, method: str, url: str, status_code: int, process_time: float):
        self.logger.info(
